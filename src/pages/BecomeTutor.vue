        ...
        <div class="col-lg-12">
          <div class="register-heading-content-wrap text-center">
            <div class="section-heading">
              ...
              <h2 class="section__title">và đồng hành cùng chúng tôi</h2>
            </div>
          </div>
        </div>
      </div>
                    ...
                    >
                      ...
                      <div class="media-body col-lg-12 mt-2">
                        ...
                        <p class="fs-14">
                          ...
                          350x200 Và các tệp phù hợp là .jpg & .png
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card card-item w-100" style="max-height: none">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div
                    class="col-lg-12 text-center"
                    v-show="is_display_require_class"
                  >
            ...
            <div class="card card-item w-100">
              <div class="card-body">
                ...
                <div class="row">
                  <div
                    class="col-lg-12 text-center"
                    v-show="is_display_require_city"
                  >
                    <p class="text-color fs-12">
                  ...
                  >
                    <p class="text-color fs-12">
                      Vui lòng chọn ít nhất 1 quận(huyện)
                    </p>
                  </div>
                  <div
                    class="col-lg-12 text-center"
                    v-show="is_display_city_already"
                  >
                    <p class="text-color fs-12">
                      Bạn đã chọn thành phố/Tỉnh đó rồi. Vui lòng chọn thành
                      phố/Tỉnh khác!
                    </p>
                  </div>
                  <div class="col-lg-9">
            ...
            <div class="card card-item w-100">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <label class="label-text">
                      Chi phí dạy(vnđ)/giờ<span class="text-color fs-14"
                        >*</span
                      >
                    </label>
                    <div class="form-group">
