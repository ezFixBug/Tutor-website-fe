        ...
        <div class="row">
          <div class="col-lg-4 responsive-column-half">
            <div class="counter-item">
              ...
              <h4 class="counter__title counter text-color-2">{{courses.length}}</h4>
              <p class="counter__meta">Khóa học đã mua</p>
            </div>
            <!-- end counter-item -->
          </div>
          <!-- end col-lg-4 -->
          <div class="col-lg-4 responsive-column-half">
            <div class="counter-item">
              ...
              <h4 class="counter__title counter text-color-4">0</h4>
              <p class="counter__meta">Khóa học yêu thích</p>
            </div>
            <!-- end counter-item -->
          </div>
          <!-- end col-lg-4 -->
          <div class="col-lg-4 responsive-column-half">
            <div class="counter-item">
              ...
              <h4 class="counter__title counter text-color-4">{{requests.length}}</h4>
              <p class="counter__meta">Đăng ký yêu cầu tìm gia sư</p>
            </div>
            <!-- end counter-item -->
          </div>
          <!-- end col-lg-4 -->
                    ...
                    >
                      <div class="card-image">
                        ...
                        <div class="course-badge-labels">
                          <div class="course-badge red">Chờ phê duyệt</div>
                        </div>
                      </div>
                      <!-- end card-image -->
                      <div class="card-body">
