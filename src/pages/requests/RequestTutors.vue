        ...
        <div class="col-lg-12" v-for="request in requests" :key="request.id">
          <div class="card card-item hover-y">
            <div class="card-body d-flex align-items-center">
              ...
              <div
                class="pl-4 col-md-2 col-sm-2 text-center"
                style="max-width: 22.666667%"
              >
                <router-link
                  :to="{
                    name: 'detail-request',
              ...
              <div class="pl-4 col-md-2 col-sm-2 text-center">
                ...
                >
                <button
                  v-if="request.user.id !== auth?.id"
                  class="btn theme-btn theme-btn-sm btn-add-offer"
                  data-id="3025"
                  @click="
                    request.offer_request?.status != 2 &&
                      handleOfferRequest(
                        request.id,
                ...
                >
                  {{
                    ...
                    request.offer_request.status_cd == 1
                      ? "Hủy đề nghị"
                      : request.offer_request &&
                        request.offer_request.status_cd == 2
                      ? "Đã duyệt"
                      : "Đề nghị dạy"
                  }}
                </button>
