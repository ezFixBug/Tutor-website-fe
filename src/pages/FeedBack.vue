      ...
      <div class="row">
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <h3 class="info__title">Địa chỉ</h3>
            <p class="info__text">Tp. Đà Nẵng</p>
          </div>
          <!-- end info-box -->
        </div>
        <!-- end col-lg-3 -->
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <h3 class="info__title">Email chúng tôi</h3>
            <p class="info__text">email@gmail.com</p>
          </div>
          <!-- end info-box -->
        </div>
        <!-- end col-lg-3 -->
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <h3 class="info__title">Số điện thoại</h3>
            <p class="info__text">0123 456 789</p>
          </div>
          <!-- end info-box -->
        </div>
        <!-- end col-lg-3 -->
      ...
      <div class="row align-items-center pt-30px">
        <div class="col-lg-5">
          <div class="contact-content pb-5">
            <div class="section-heading">
              <h2 class="section__title pb-3">
                Chúng tôi rất muốn nhận được sự góp ý từ bạn
              </h2>
              <p class="section__desc">
                Nếu bạn có bất cừ thắc mắc hay những góp ý, bạn có thể gửi thông
                tin ở đây. Chúng tôi rất hân hạnh nhận được những góp ý quý giá
                này. Xin cả ơn!
              </p>
            </div>
            <!-- end section-heading -->
            <ul
              class="social-icons social-icons-styled social--icons-styled pt-30px"
            >
              <li>
                <a href="https://www.facebook.com/VN.Smart.edu"
        ...
        <div class="col-lg-7">
          <div class="card card-item">
            <div class="card-body">
              <form @submit.prevent="handleAddFeedback" class="contact-form">
                <div class="input-box">
                  <label class="label-text"
                    >Tên của bạn<span class="text-color">*</span></label
                  >
                  <div
                    v-for="(error, index) in dataErrors.name"
                    :key="index"
                ...
                <div class="input-box">
                  <label class="label-text"
                    >Email<span class="text-color">*</span></label
                  >
                  <div
                ...
                <div class="input-box">
                  <label class="label-text"
                    >Thông điệp<span class="text-color">*</span></label
                  >
                  <div
                    v-for="(error, index) in dataErrors.content"
                    :key="index"
                    class="text-danger validation-summary-errors fs-14"
                  >
                    {{ error }}
...
export default {
  ...
  methods: {
    async handleAddFeedback() {
      this.is_loading = true;
      const res = await $http.post("/feedback", this.feedback);
      if (get(res, "data.result", false)) {
        createToast("Đã gửi feedback!", {
          type: "success",
          timeout: 6000,
        });
